...
MOBILE_JSON="$JSON_DIR/removed product-mobile.json"
DESKTOP_JSON="$JSON_DIR/removed product-desktop.json"

lighthouse_ok=0

if command -v lighthouse >/dev/null 2>&1; then
  if lighthouse "http://127.0.0.1:${PORT}/removed product.html" \
    --quiet \
...
css = root / "removed product.css"
js = root / "script.js"
html = root / "removed product.html"

hero_dark_png = root / "assets/branding/hero/removed product_hero.png"
hero_light_png = root / "assets/branding/hero/removed product_hero_light.png"
...
preferred_assets = [
    root / "assets/branding/hero/removed product_hero",
    root / "assets/branding/hero/removed product_hero_light",
