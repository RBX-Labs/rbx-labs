...
check_file "Hero dark WebM" "$ROOT_DIR/assets/branding/hero/removed product_hero.webm" 1920 1080 20 235
check_file "Hero light WebM" "$ROOT_DIR/assets/branding/hero/removed product_hero_light.webm" 1920 1080 80 250
